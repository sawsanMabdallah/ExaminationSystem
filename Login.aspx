...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <td rowspan="3" style="width: 475px">
            <asp:Login ID="Login1" runat="server" Height="281px" style="margin-left: 0px" Width="470px" CreateUserUrl="~/Welcome.aspx" OnAuthenticate="Login1_Authenticate">
                <LayoutTemplate>
                    <table cellpadding="1" cellspacing="0" style="border-collapse:collapse;">
                        <tr>
                            <td>
                                <table cellpadding="0" style="height:281px;width:470px;">
                                    <tr>
